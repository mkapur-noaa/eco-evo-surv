## Optimize Strata for multispp survey in n barents sea
## Code apated from Zack Oyafuso (zack.oyafuso@noaa.gov)
## "Optimization scheme for a multispecies stratified design"

## We need to optimize the allocation of effort for a given number of strata
## in the multispecies framework. We expect this to give us a CV in between
## what we'd get for a mono-species survey (which would be lower) and a SRS (simple random sampling) survey.
## This should be run one time to determine 
...
##   Load Input Data ----
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
load(here::here('r','chukchi_survey_evaluation-main','data','survey_opt_data',"optimization_data_nbs.RData"))
grid_pts <- terra::vect(here::here('r','chukchi_survey_evaluation-main','data','survey_opt_data',"grid_pts_nbs.shp"))
source(here::here('r','chukchi_survey_evaluation-main','modified_functions',"plot_survey_opt_map.R"))
source(here::here('r','chukchi_survey_evaluation-main','modified_functions',"calc_expected_CV.R"))
